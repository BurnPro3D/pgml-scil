...
2. Wind speed (scalar broadcast over grid)
3. Wind direction - sin component
4. Wind direction - cos component
5. Ignition map / source map
...
Experiments are logged via **MLflow** or **Weights & Biases** (configured per run via `logging_framework` in the config). See `docs/mlflow/README.md` for MLflow setup instructions.

# References

QUIC-Fire simulator used for data generation:
